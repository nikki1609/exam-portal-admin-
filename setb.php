...
<?php
include 'int.php';
$query=mysql_query("SELECT * FROM test where sets=2");
$q=mysql_query("SELECT * FROM test  where sets=2");
$a= mysql_query("SELECT * FROM test  where sets=2");
$b=mysql_query("SELECT * FROM test  where sets=2");
$c=mysql_query("SELECT * FROM test  where sets=2");
?>
<div class="row">
